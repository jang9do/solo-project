...
<div id="wrap">
	...
	<div id="content">
		<form action="${conPath }/boardInput.bo" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					...
					<td colspan="2"><input type="text" name="bTitle" required="required"></td>
				<tr>
				<tr>
					<th>작성자</th>
					<td><input type="text" name="bName" readonly="readonly" value='${empty login? "비회원":login.mName }'></td>
					<th>파일첨부</th>
