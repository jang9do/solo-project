...
<div id="wrap">
	...
	<div id="content">
		<form action="${conPath }/boardReply.bo" method="post" enctype="multipart/form-data">
			...
			<table>
				...
				<tr>
					<th>작성자</th>
					<td><input type="text" name="bName" readonly="readonly" value='${login.mId}'></td>
					<th>파일첨부</th>
				...
				<tr>
					<td colspan="4"><textarea class="jqte-test" name="bContent"></textarea></td>
				</tr>
				<tr>
					<td colspan="4"><input type="submit" value="답글 작성">&nbsp;&nbsp;<input type="button" value="뒤로가기" onclick="history.back()"></td>
				</tr>
			</table>
		</form>
	</div>
