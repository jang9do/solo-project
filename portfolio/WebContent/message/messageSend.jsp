...
<body>
<div id="wrap">
	<p><span>쪽지보내기</span><a href="${conPath }/messageMulSendView.mes">단체 쪽지보내기 -></a></p>
	<form action="${conPath }/mesSend.mes" method="post">
		...
		<table>
			...
			<tr>
				...
				<th>받는 사람</th>
				<td><input type="text" name="mesFrom" required="required"></td>
			</tr>
			<tr>
				<th colspan="4">내용</th>
			</tr>
